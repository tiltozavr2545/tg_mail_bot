...
class Summarizer:
    def __init__(self, cfg: Config) -> None:
        ...
        instruction = [
            ...
            "материал, его содержание НЕ пересказывай. Просто сообщи, что прислали "
            "лекцию/материал, и назови её тему или название файла.",
        ]
        ...
        if cfg.tracked_people:
            ...
            instruction.append(
                ...
                f"{people}. Для каждого укажи его результат (за какое задание и из "
                "скольки максимум, если это указано); учитывай сокращения и разный "
